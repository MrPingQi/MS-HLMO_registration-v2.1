...
parameters.disp       = 0;    % Display intermediate results
...
tic,[I1_r,I2_r,I1_rs,I2_rs,I3,I4,tform,pos] = Transformation(image_1,image_2,...
...
data = {cor1;cor2; tform}; Imwrite(data,[save_path,Date,'0 corresponds','.mat']);
